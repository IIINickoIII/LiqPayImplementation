...
namespace RetroCarShop.Models
{
    public class LiqPayHelper
    {
        ...
        /// <returns></returns>
        static public LiqPayCheckoutFormModel GetLiqPayModel(string order_id, string description, int price)
        {
            ...
            var signature_source = new LiqPayCheckout()
            {
                ...
                result_url = "https://localhost:44376/Home/Redirect",
                server_url = "https://localhost:44376/Home/Redirect",
